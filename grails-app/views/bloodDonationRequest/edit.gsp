...
<html>
	...
	<body>
		<a href="#edit-bloodDonationRequest" class="skip" tabindex="-1"><g:message code="default.link.skip.label" default="Skip to content&hellip;"/></a>
		...
		<div id="edit-bloodDonationRequest" class="content scaffold-edit" role="main">
			...
			<g:form method="post" >
				...
				<g:hiddenField name="version" value="${bloodDonationRequestInstance?.version}" />
				<fieldset class="form">
