...
<html>
	...
	<body>
		<a href="#edit-bloodDonationUser" class="skip" tabindex="-1"><g:message code="default.link.skip.label" default="Skip to content&hellip;"/></a>
		...
		<div id="edit-bloodDonationUser" class="content scaffold-edit" role="main">
			...
			<g:form method="post" >
				...
				<g:hiddenField name="version" value="${bloodDonationUserInstance?.version}" />
				<fieldset class="form">
